...
public class ResetPassword extends HttpServlet {
    ...
    protected String sendmMail() throws AddressException, MessagingException {
        System.setProperty("mail.smtp.ssl.protocols", "TLSv1.2");
        String to = "longzenbiker@gmail.com";
        ...
        final String subject = "Code Xác thực";
        ...
        msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("longzenbiker@gmail.com", false));
