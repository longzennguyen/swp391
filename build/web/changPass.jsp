...
<%@page import="controller.DBContext"%>
                ...
                <div class="modal-body">
                    <form action="changPassword" method="POST">
                        <div>
                            ...
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Mật khẩu cũ</label>
                                <div class="col-10">
                                    <input placeholder="Mật khẩu mới" class="form-control" type="password" name="oldpass" id="oldpass" onkeyup="validatePasswordr()">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="modal-footer" >
                            ...
                            <button type="submit" class="btn btn-primary" name="service" value="change"
                                    >Khôi phục</button>
                        </div>
                </div>
                </form>
