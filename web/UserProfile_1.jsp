                ...
                <div class="row">
                    ...
                    <div class="col-md-5 border-right">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Số điện thoại: </label><h5>${phone}</h5></div>
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Email: </label><h5>${email}</h5></div>
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Địa chỉ: </label><h5>${address}</h5></div>                            
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Ngày sinh: </label><h5>${dob}</h5></div>
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Role: </label> <h5>Customer</h5></div>                                                         
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Giới tính: </label> <h5>${gender}</h5></div>                             
                                <div class="col-md-12" style="margin-top: 20px"><label class="labels">Trạng thái: </label><h5>Active</h5></div>                             
                            </div>                                                                    
                        </div>                  
                    </div>
                    <div class="mt-5 text-center col-md-10">
                        <a href="userlist.jsp"><button class="btn btn-primary profile-button" type="button">Trở về</button></a>
                    </div>
                </div>
            </div>
        </div>
