    ...
    <body>
                        ...
                        <table style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><h4 style="margin: 6px"><input style="    width: 60%;" type="email" value="duyhdse05810" name="email" value=""/></h4></td>
                                </tr>
                                <tr>
                                    <td><h4 style="margin: 6px">PHONE NUMBER: </h4></td>
                                    <td><h4 style="margin: 6px"><input type="text" value="0964138498" name="phone"/> </h4> </td>
                                </tr>
                                <tr>
                                    <td><h4 style="margin: 6px">ADDRESS: </h4></td>
                                    <td><h4 style="margin: 6px"><input type="text" value="Dong Anh, Ha Noi, VN" name="address"/></h4></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr><td><h4 style="margin: 6px;">OUR BANKING ACCOUNT: </h4></td>
                                    <td>
                                        <select style="font-size: 17px;     width: 60%;
                                                font-size: 22px;">
                                        ...
                                        <div style="margin-top: 10px;font-size: 18px">
                                            <label id="stk">STK: 012318212362136128321</label>&nbsp;&nbsp;&nbsp;
                                            <label>NGUOI NHAN: HOANG DINH DUY</label>
                                        </div>
                                    </td>
                                </tr>
        ...
        <script>
                                                    function addToLocalStorage(val) {
                                                        var stored = localStorage.getItem("bankStore");
                                                        if (stored == null) {
