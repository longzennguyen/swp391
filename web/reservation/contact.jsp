                    ...
                    <div style="margin-left: 10px;color: black;width: 100%">
                        <form action="${pageContext.request.contextPath}/reservation/finish" method="POST">
                            ...
                            <table style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><h4 style="margin: 6px">${logginedUser.getGender()}</h4></td>
                                    </tr>
                                    <tr>
                                        <td><h4 style="margin: 6px">EMAIL ADRESS: </h4></td>
                                        <td><h4 style="margin: 6px">${logginedUser.getEmail()}</h4></td>
                                    </tr>
                                    <tr>
                                        <td><h4 style="margin: 6px">PHONE NUMBER: </h4></td>
                                        <td><h4 style="margin: 6px">${logginedUser.getPhone()} </h4> </td>
                                    </tr>
                                    <tr>
                                        <td><h4 style="margin: 6px">ADDRESS: </h4></td>
                                        <td><h4 style="margin: 6px">${logginedUser.getAddress()}</h4></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><h4 style="margin: 6px; vertical-align: top;height: 101px">NOTE:  </h4></td>
                                        <td><h4 style="margin: 6px"> <textarea rows="5" name="note"> test</textarea> </td>
                                    </tr>
                                </tbody>
                            </table>
                            <br>
                            ...
                            <div style="width: 100%;text-align: center">
                                <input type="submit" value="Finish" class="btn btn-primary" style="border-radius: 4px;font-size: 18px;padding: 8px 35%" />
                                <br>
                                <br>
