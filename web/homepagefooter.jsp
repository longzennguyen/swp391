<%-- 
    ...
    Created on : 14-10-2021, 21:06:29
        ...
        <footer class="main-footer">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="footer-col">
                                ...
                                <h4 class="footer-title">About Children Care <span class="title-under"></span></h4>

                                <div class="footer-content">

                                    <p>
                                        <strong>ChildrenCare </strong> is ..... ipsum dolor sit amet, consectetur adipiscing elit. Ut at eros rutrum turpis viverra elementum semper quis ex. Donec lorem nulla, aliquam quis neque vel, maximus lacinia urna.
                                    </p> 
            ...
            <div class="footer-bottom">
                ...
                <div class="container text-right">
                    ChildrenCare @ copyrights 2021 - by DucNT
                </div>
            </div>
